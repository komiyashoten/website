...
<section class="wrap_big_banner">
	<?php 
	$page_id = get_page_by_path("komiyashoten-women");
	$page_id = $page_id->ID;
	?>
	<ul class="big_banner">
		<?php 
		$page_list = new WP_Query([ 'post_type' =>'page', 'post_parent' => $page_id, 'posts_per_page' => 100, 'order' => 'ASC', 'post__not_in' => array(663,665,668,671,679) ]);
