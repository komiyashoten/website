	...
	<ul>
		<li class="has_children"><a href="/men/">MEN</a>
			<div class="dropdown_inner">
				...
				<ul>
					<li class="select_title">CATEGORY</li>
				...
				<ul>
					<li class="select_title">PRICE</li>
				...
				<ul>
					<li class="select_title">BRANDS</li>
					<li class="img_banner"><a href="/komiyashoten-men/"><img src="/wp-content/themes/komiya/img/dropdown_brand2.png" width="145"></a></li>
					<li class="img_banner"><a href="/daily-use-umbrella/"><img src="/wp-content/themes/komiya/img/dropdown_brand1.png" width="145"></a></li>
				</ul>
			</div>
		</li>
		<li class="has_children"><a href="/women/">WOMEN</a>
			<div class="dropdown_inner">
				...
				<ul>
					<li class="select_title">BRANDS</li>
					<li class="img_banner"><a href="/komiyashoten-women/"><img src="/wp-content/themes/komiya/img/dropdown_brand2.png" width="145"></a></li>
					<li class="img_banner"><a href="/daily-use-umbrella/"><img src="/wp-content/themes/komiya/img/dropdown_brand1.png" width="145"></a></li>
				</ul>
			</div>
		</li>
