...
<section class="body1 clear">
	<?php if ( has_term('men', 'large_cat')): ?> <!-- MENSの時のSIDEメニュー開始 -->
	<div class="side_area"> <!-- SIDEエリアDIV開く -->
    ...
    <?php elseif ( has_term('women', 'large_cat')): ?> <!-- LADYSの時のSIDEメニュー開始 -->
	<div class="side_area"> <!-- SIDEエリアDIV開く -->
		<div class="side_category_menu">
    ...
    <?php endif; ?>
	<?php if ( has_term('men', 'large_cat') || has_term('women', 'large_cat') ): ?> <!-- 男女共通のSIDEのサーチエリア -->
    ...
    <?php endif; ?>	
	</div> <!-- 男女ともにSIDEエリアDIV閉じる -->
	
	<?php if ( have_posts() ) : ?>
	<section class="right_area"> <!-- 検索にHITしたときのRIGHT　AREA　SECTION開く -->
 ...
    	jQuery('select option[value="0"]').attr("selected", "selected");*/
    ...
    <?php else : ?>
	<div class="side_area"> <!-- 検索にHITしなかったときのSIDEエリアDIV開く -->
		<div class="side_category_menu">
			<h3><a href="/men/">MEN</a></h3>
			<ul class="col2 clear">
				<li><a href="/large_cat/long+men/"><strong>長傘</strong></a></li>
	...
	</div> <!-- 検索にHITしなかったときのSIDEエリアDIV閉じる -->
 ...
    	jQuery('select option').attr("selected", false);
        ...
        if ( size_cat_index >= 0 ) {
            ...
            for (var i = 0; i < size_cat_array_length; i++ ) {
				...
				jQuery('select option[value='+targetValue+']').prop('selected', true);
            }
        }
